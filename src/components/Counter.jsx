...
const StatsCounter = () => {
  const [counters, setCounters] = useState([
    { id: 1, current: 0, target: 10500, text: "Sailers active our site", icon: FaUserTie },
    { id: 2, current: 0, target: 33000, text: "Monthly Product Sale", icon: FaBoxOpen },
    { id: 3, current: 0, target: 45500, text: "Customer active in our site", icon: FaUserFriends },
    { id: 4, current: 0, target: 25000, text: "Annual gross sale in our site", icon: FaMoneyBillWave }
  ]);

  // formatNumber function যোগ করুন
        ...
        <div className="flex items-center justify-between">
          {counters.map((stat) => {
            ...
            return (
              <div 
                key={stat.id}
                className="group bg-white rounded border border-gray-300  p-6 text-center transition-all duration-300 hover:bg-[#db4444]  "
              >
                {/* Icon */}
